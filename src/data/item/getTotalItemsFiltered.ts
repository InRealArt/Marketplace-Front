...
/**
 * Compte tous les items selon les mêmes critères que getAllItems
 * 
 ...
 */
export async function getTotalItemsFiltered(
    options: {
        priceMin?: number;
        priceMax?: number;
        techniqueId?: number
    ...
    try {
        ...
        console.error('Erreur lors du comptage des items filtrés:', error)
        throw new Error('Impossible de compter les items filtrés')
    }
} 